...
namespace UnityEditor.XCodeEditor
{
	public partial class XCProject : System.IDisposable
	{
		...
		public void AddSystemTargetTeamID (string teamID){
			
			XCProjectSystemTeamID systemCapabilities=XCProjectSystemTeamID.createWithProject(_project);
			systemCapabilities.visitAddSystemTargetTeamID (teamID);
		...
		public bool AddFolder( string folderPath, PBXGroup parent = null, string[] exclude = null, bool recursive = true, bool createBuildFile = true )
		{
			...
			foreach( string directory in Directory.GetDirectories( folderPath ) ) {
				...
				if(directory.EndsWith( ".bundle" ) || directory.EndsWith(".framework")|| directory.EndsWith(".xcassets")) {
